...
public class CustomerCanGetCardNoAndPinController {
	...
	@Autowired
	CustomerCanGetCardNoAndPinSrvice service;
	
	@PostMapping(path = "/api/v1/customer/get/cardNoAndPin")
	public CustomerCanGetCardNoAndPinResponse getCustomerInformation(@RequestBody CustomerCanGetCardNoAndPinRequest request) {
